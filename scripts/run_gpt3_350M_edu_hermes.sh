...
# 350M parameter model on 300B tokens
# note context length: 1024 -> 2048 for GPT-3
# => 6 * 350e6 * 300e9 = 7.44e18 ~= 2.2e20 capability model
...
while true; do
    ...
    mpirun -np 8 ./train_gpt2cu \
                -i "dev/data/edu_fineweb_hermes100B/fineweb_train_*.bin" \
                -j "dev/data/edu_fineweb_hermes100B/fineweb_val_*.bin" \
                -o $out_dir \
                -v 250 -s 20000 -g 144 \
                -h 1 \
                -b 32 -t 2048 \
