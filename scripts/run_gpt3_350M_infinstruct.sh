...
out_dir="log_gpt3_350M_infinstruct"
done_file="$out_dir/DONE_00000863"
while true; do
    ...
    mpirun -np 2 ./train_gpt2cu \
                -i "dev/data/infinstruct/infinstruct_train_*.bin" \
                -j "dev/data/infinstruct/infinstruct_val_*.bin" \
                -o $out_dir \
                -v 250 -s 1000 -g 144 \
                -h 1 \
                -b 8 -t 2048 \
