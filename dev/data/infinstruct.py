...
ds = load_dataset("jrahn/Infinity-Instruct_chatml", split="train")
...
with mp.Pool(nprocs) as pool:
    ...
    for tokens in pool.imap(tokenize, ds, chunksize=16):
        ...
        if token_count + len(tokens) < shard_size:
            ...
            split = "val" if shard_index == 0 else "train" # use shard 100 (from Part 3) as validation set
